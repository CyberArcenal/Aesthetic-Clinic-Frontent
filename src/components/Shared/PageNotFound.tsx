...
const PageNotFound: React.FC = () => {
    // Quick links for aesthetic clinic
    const quickLinks = [
        { path: '/dashboard', label: 'Dashboard', icon: LayoutDashboard, color: 'var(--primary-color)' },
        { path: '/clients', label: 'Clients', icon: Users, color: 'var(--accent-blue)' },
        { path: '/treatments', label: 'Treatments', icon: Stethoscope, color: 'var(--accent-green)' },
        { path: '/appointments', label: 'Appointments', icon: CalendarDays, color: 'var(--accent-orange)' },
    ];
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: 'var(--background-color)' }}>
            ...
            <div className="absolute inset-0 overflow-hidden opacity-10 pointer-events-none">
                <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full" style={{ background: 'var(--primary-color)', filter: 'blur(60px)' }}></div>
                <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full" style={{ background: 'var(--accent-purple)', filter: 'blur(60px)' }}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full" style={{ background: 'var(--accent-blue)', filter: 'blur(60px)' }}></div>
            </div>
            ...
            <div className="relative z-10 max-w-4xl w-full">
                ...
                <div className="compact-card rounded-2xl p-8 mb-8 text-center transition-all duration-300 ease-in-out transform hover:scale-[1.01] hover:shadow-2xl" style={{
                    ...
                    <p className="text-base mb-6 max-w-2xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
                        The page you're looking for seems to have wandered off into the digital corridors of our clinic system.
                        It might have been moved, deleted, or perhaps it never existed in our records.
                    </p>
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm mb-2" style={{ color: 'var(--text-secondary)' }}>
                        Still lost? Contact clinic support if you believe this is an error
                    </p>
